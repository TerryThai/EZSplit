...
export {default as PopupUpload} from './User-Home/popupUpload'
...
export {default as UserBalances} from './Table/UserBalances'
export {default as SuperSideBar} from './Navbar/SuperSideBar'
